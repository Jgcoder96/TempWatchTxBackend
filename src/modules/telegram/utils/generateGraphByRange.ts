...
// Opcional: Para mostrar los meses en español
// import { es } from 'date-fns/locale';
// Chart.register(TimeScale.register(es));
...
export const generateGraphByRange = async (data: Data[]) => {
  try {
      ...
      options: {
        ...
        scales: {
          ...
          x: {
            type: 'time',
            time: {
              unit: 'day', // Unidad principal ahora es el día
              tooltipFormat: 'dd/MM/yyyy HH:mm', // Formato para el tooltip al pasar el ratón
              displayFormats: {
                day: 'dd MMM', // Cómo se muestra la etiqueta en el eje. Ej: '19 Jun'
              },
            },
            title: {
              display: true,
              text: 'Fecha', // Título del eje actualizado
              font: {
                weight: 'bold',
                size: 14,
              },
            ...
            ticks: {
              autoSkip: true, // Permitimos que salte etiquetas si hay muchas para que no se solapen
              maxRotation: 45,
              minRotation: 45,
              major: {
                enabled: true,
